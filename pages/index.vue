            ...
            <div class="flex-1 flex items-center items-stretch justify-start">
              ...
              <div class="hidden sm:block sm:ml-6">
                <div class="flex space-x-4">
                  ...
                  <a href="/categories" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Categorias</a>
                </div>
              </div>
            </div>
              ...
              <div class="ml-3 relative">
                <div>
                  <button type="button" class="bg-gray-800 flex text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                    <img class="h-8 w-8 rounded-full" src="https://media.licdn.com/dms/image/D4D03AQE2tbSUoatiMw/profile-displayphoto-shrink_800_800/0/1688494374551?e=1695859200&v=beta&t=uEhLPWtJUBq0Q8tjXLyZpkfjvqJ4CguBt56q8LQ4FCc" alt="">
                  </button>
                </div>
              </div>
            </div>
